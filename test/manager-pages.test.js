...
test('about page shows bundled DSH and installed plugin versions', () => {
  ...
  assert.doesNotMatch(page, /file-viewer-version/)
  assert.doesNotMatch(page, /codex-subagent-version/)
  ...
  assert.match(page, /ds-harness-remote/)
  assert.match(main, /remote: aboutPluginVersion\('ds-harness-remote'\)/)
  assert.doesNotMatch(main, /fileViewer|dsh-file-viewer/)
  assert.doesNotMatch(main, /codexSubagent/)
