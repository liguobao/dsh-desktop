...
test('release builds bundle the prebuilt remote plugin and its runtime dependency tree', () => {
  assert.equal(packageJson.dependencies['dsh-remote'], 'github:liguobao/deepseek-harness-remote#v0.3.19')
...
test('release builds bundle the prebuilt file viewer plugin and its runtime dependency tree', () => {
  assert.equal(packageJson.dependencies['dsh-file-viewer'], 'github:liguobao/dsh-file-viewer#v0.2.2')
